...
//	
	...
	public MobileElement cercaMiMira;
	...
	public MobileElement cercaMiPersonaliceBusqueda;

	@AndroidFindBy(uiAutomator = "new UiSelector().resourceId(\"fi.cr.gmalv.mutualmovil.activities:id/itemCheckBox\")")
	public List<MobileElement> cercaMiPersonaliceBusqueda_Opcion;

	// Buscar texto
	@AndroidFindBy(id = "search_button")
	public MobileElement cercaMiBotonBuscarLugar;

	@AndroidFindBy(id = "search_src_text")
	public MobileElement cercaMiCampoBuscar;

	@AndroidFindBy(id = "search_close_btn")
	public MobileElement cercaMiCampoBuscar_Cerrar;

	// Flujo completo
	@AndroidFindBy(id = "swap_map_list")
	public MobileElement cercaMiSegunUbicacion;

	@AndroidFindBy(id = "changeToMap")
	public MobileElement cercaMiSegunUbicacionVolverMapa;

	// Boton Segun mi Ubicación
	@AndroidFindBy(id = "locationTextView")
	public MobileElement cercaMiSegunUbicacionSeleccionarUbicacion;
	...
	public List<MobileElement> cercaMiSegunUbicacionSeleccionarUbicacionPCD;
	...
	public List<MobileElement> cercaMiSegunUbicacionSeleccionarUbicacionPCD_seleccion;

	// Cancelar seleccion
	@AndroidFindBy(id = "cancelAddresPicker")
	public MobileElement cercaMiSegunUbicacionSeleccionarUbicacionPCD_cancelar;

	// Listo seleccion provincia/canton/distrito
	@AndroidFindBy(id = "doneSettingLocation")
	public MobileElement opcionesSegunUbicacion_Listo;
	...
	public List<MobileElement> cercaMiSegunUbicacionSeleccionarDelMenu;
