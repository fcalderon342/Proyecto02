...
public class EjecucionInicioPrueba extends AbstractTest {
	...
	@Title("Cambiar horientación del dispositivo a vertical")
	@Step
	public void girarVertical() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico de girar dispositivo", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void aceptarPermisos() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico de aceptar permisos", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarHome() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico en presionar Home", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarNotificaciones() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico en presionar Notificaciones", e.toString(),
			// suite, nombreCarpeta, fecha);
	...
	public void presionarBotonTipoCambio() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico presionar Boton Tipo de Cambio",
			// e.toString(), suite, nombreCarpeta, fecha);
	...
	public void presionarMisProductos() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico presionar mis productos", e.toString(),
			// suite, nombreCarpeta, fecha);
	...
	public void presionarMenu2Veces() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico en prueba Menu - Menu", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarMenuInicio() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Inicio", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarMenuContactenos() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Contactenos", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarSalirContactenos() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Salir de Contactenos", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarMenuCalculadora() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu Calculadora", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarCalculadoraCredito() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Calculadora Credito", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarCalculadoraInversion() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Calculadora - Inversion", e.toString(),
			// suite, nombreCarpeta, fecha);
	...
	public void presionarMenuFavoritos() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Favoritos", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarMenuTransferencias() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Transferencias", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarMenuPagos() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Pagos", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarPagosTablet() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Pagos Tablet/Ipad", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarMenuPerfil() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Perfil", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarMenuConfiguracion() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Configuracion", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarIniciarSesionMenuyTablet() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Menu - Iniciar Sesion", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	public void presionarCercaMiAceptarPermisos() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Aceptar Permisos Cerca de Mi", e.toString(),
			// suite, nombreCarpeta, fecha);
	...
	public void presionarCercaMi() {
		...
		try {
			...
			// logger.enviarLog("Error Tecnico Boton Cerca de Mi", e.toString(), suite,
			// nombreCarpeta, fecha);
	...
	@Title("Presionar Menu - PreguntasFrecuentes todos los dispositivos")
	@Step
	public void preguntasFrecuentes() {

		String nombreCarpeta = "presionarPreguntasFrecuentes";

		try {

			Assert.assertEquals(true,
					app.componentesGenerales().accionesUniversales().preguntasFrecuentes(nombreCarpeta, fecha, suite));
			...
			org.testng.Assert.fail("Error QA: No se ha logrado validar en presionarPreguntasFrecuentes."
					+ "\nParte de los componentes del aplicativo no son accesibles."
					+ "\nRevise el estado el ambiente de certificacion."
					+ "\nPresionar Iniciar Sesion no se realiza de manera correcta, revise que no tenga algun componente sobre o tenga una nombre de variable diferente.");
		}
	...
	@Title("Cerca de Mi")
	@Step
	public void cercadeMiApp() {

		String nombreCarpeta = "CercaDeMiApp";

		try {

			Assert.assertEquals(true,
					app.componentesGenerales().accionesUniversales().cercadeMiApp(nombreCarpeta, fecha, suite)); // Llamar
																													// al
																													// boton
			...
			org.testng.Assert.fail("Error QA: No se ha logrado Presionar Cerca de Mi."
					+ "\nParte de los componentes del aplicativo no son accesibles."
					+ "\nRevise el estado el ambiente de certificacion."
					+ "\nPresionar Cerca de Mi App no se realiza de manera correcta, revise que no tenga algun componente sobre o tenga una nombre de variable diferente.");
		}
	...
	public void promocionesMis() {
		...
		try {
			...
			Assert.assertEquals(true,
					app.componentesGenerales().accionesUniversales().promocionesMis(nombreCarpeta, fecha, suite)); // Llamar
																													// al
																													// boton

		} catch (AssertionError e) {

			org.testng.Assert.fail("Error QA: No se ha logrado Presionar Mis Promociones."
					+ "\nParte de los componentes del aplicativo no son accesibles."
					+ "\nRevise el estado el ambiente de certificacion."
					+ "\nPresionar Mis Promociones App no se realiza de manera correcta, revise que no tenga algun componente sobre o tenga una nombre de variable diferente.");
		}
